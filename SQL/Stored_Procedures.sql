...
--sp_GetExecutiveSummary : a high-level summary of every market so I can compare them quickly.

create Procedure dbo.sp_GetExecutiveSummary
AS
BEGIN
set nocount on
select 
...
from dbo.vw_MarketSummary
order by LatestClosePrice desc
end;
go

EXEC dbo.sp_GetExecutiveSummary